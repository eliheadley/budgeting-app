...
1. Clone the repo
   ```sh
   git clone https://github.com/eliheadley/expense-tracker
   ```
4. Build
   ```sh
...
Eli Headley - eliheadley@gmail.com

Project Link: [https://github.com/eliheadley/expense-tracker](https://github.com/eliheadley/expense-tracker)
